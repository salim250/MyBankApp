...
import {VirementComponent} from "./pages/EspaceClient/virement/virement.component";
import {DemandeComponent} from "./pages/EspaceClient/demande/demande.component";
import {ExtraitComponent} from "./pages/EspaceClient/extrait/extrait.component";
import {TransfertComponent} from "./pages/EspaceClient/transfert/transfert.component";
...
const routes: Routes = [
  ...
  { path: 'virementClient', component: VirementComponent },
  { path: 'Demande', component: DemandeComponent },
  { path: 'Extrait', component: ExtraitComponent },
  { path: 'transfert', component: TransfertComponent },
  { path: 'liste/:id', component: ClientComponent },
  { path: 'liste/:id', component: ClientComponent },
  { path: 'liste/:id', component: ClientComponent },
